  ...
  return (
    <div className="ueberMich-container">
      ...
      <p className="goalsfooter">
        ...
        <br />
        <br />
        <br />I am excited about the possibilities that lie ahead and grateful
        for the opportunity to pursue my passion in the gaming industry. I am
